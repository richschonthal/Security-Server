...
CRegKey CSSConfig::m_regRoot(HKEY_LOCAL_MACHINE, "Software\\@COMPANY\\SecurityServer\\1.0");
...
void CSSConfigThread::ReadData()
	...
	CRegValueSz valStr(CSSConfig::m_regRoot, "LogFilePath");
	...
	CRegValueDWord valNum(CSSConfig::m_regRoot, "TraceLevel");
