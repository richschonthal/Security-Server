...
class CSecuritySystem : public CSystem  
	...
	public:
		...
		CSSIOSubSystem* GetIOSubSystem();
		CDBSubSystem* GetDBSubSystem();
...
inline CClientSubSystem* CSecuritySystem::GetClientSubSystem() { return m_pClientSubSystem; }
inline CSSIOSubSystem* CSecuritySystem::GetIOSubSystem() { return m_pIOSubSystem; }
inline CDBSubSystem* CSecuritySystem::GetDBSubSystem() { return m_pDBSubSystem; }
