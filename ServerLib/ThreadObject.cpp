...
//--------------------------------------------------------------------------------
IMPLEMENT_DYNCREATE(CThreadObject, CSystemObject);
...
//--------------------------------------------------------------------------------
void CThreadObject::OnStateChange(DWORD nState)
	{
	// if the state is state_stop or higher then we'll
	// delay acking it til the thread is ready to exit
