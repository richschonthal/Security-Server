...
//--------------------------------------------------------------------------------
void CPACSDatabase::Init(const CRegKey& regKey)
	{
	CRegValueSz rvIn(regKey, NULL);
	...
	TRACE("ConnectString=%s", (LPCTSTR) m_sDBConnectString);
	...
	TRACE("TableAccount=%s", (LPCTSTR) m_sTableAccountName);
	...
	TRACE("ProcedureAccount=%s", (LPCTSTR) m_sProcAccountName);
	}
